        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripDetailEntityId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripDetails_TripDetails_TripDetailEntityId",
                        column: x => x.TripDetailEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripDetails_TripDetailEntityId",
                table: "TripDetails",
